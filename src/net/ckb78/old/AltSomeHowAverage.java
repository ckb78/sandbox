...
public class AltSomeHowAverage {
   public static void main(String[] args) throws Exception {
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(System.in));
        int a = Integer.parseInt(bufferedReader.readLine()), b = Integer.parseInt(bufferedReader.readLine()), c = Integer.parseInt(bufferedReader.readLine());
        int midnum = (b == c) ? c : a;
        if ((b < a && b > c) || (b > a && b < c))
            midnum = b;
