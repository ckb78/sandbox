    ...
    public static void main(String[] args) {
        ...
        while (play.equals("j")) {
            ...
            while (tries > 0) {
                ...
                usedTries++;
                if (guess == num) {
                    System.out.format("Du gjettet riktig etter %d forsøk.", usedTries);
                    correctGuess = 1;
                    break;
                } else {
                    tries--;
                    if (guess > num) {
                        System.out.format("Tallet jeg tenker på er lavere enn %d. ", guess);
                        System.out.format("\nDu har %d forsøk igjen. ", tries);
                    } else {
                        System.out.format("Tallet jeg tenker på er høyere enn %d. ", guess);
                        System.out.format("\nDu har %d forsøk igjen. ", tries);
                    }
                }
            }
